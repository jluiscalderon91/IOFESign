...
public interface PasswordretrieverRepository extends CrudRepository<Passwordretriever, Integer> {
    ...
    Optional<Passwordretriever> findFirstBySentAndActiveAndDeletedOrderByPriorityAsc(byte sent, byte active, byte deleted);
