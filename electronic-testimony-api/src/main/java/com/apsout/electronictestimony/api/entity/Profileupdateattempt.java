...
@Entity
@Table(name = "profileupdateattempt")
public class Profileupdateattempt {
    private Integer id;
    ...
    public boolean equals(Object o) {
        ...
        Profileupdateattempt that = (Profileupdateattempt) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, personId, lastAttemptAt, createAt, active, deleted, observation);
    }
